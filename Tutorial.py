...
if os.path.isdir('Tensorflow\\workspace\\models\\'+CUSTOM_MODEL_NAME):
...
get_ipython().system("copy {PRETRAINED_MODEL_PATH+r'\\\\ssd_mobilenet_v2_fpnlite_320x320_coco17_tpu-8\\\\pipeline.config'} {MODEL_PATH+'\\\\'+CUSTOM_MODEL_NAME}")
